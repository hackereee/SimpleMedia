...
int gussDuration(AVFormatContext *pFormatCtx, int audioStreamIndex)
{
    int64_t duration = pFormatCtx->streams[audioStreamIndex]->duration;
    int timeBase = pFormatCtx->streams[audioStreamIndex]->time_base.den;
